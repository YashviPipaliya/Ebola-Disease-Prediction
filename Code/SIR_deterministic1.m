...
xx = plot(t, outS,'k','Linewidth',0.5);
xlabel('Time')
 ylabel('Number of Individuals')
hold on
yy = plot(t, outE,'b','Linewidth',0.5);
hold on
zz = plot(t, outI,'r','Linewidth',0.5);
hold on
pp = plot(t, outR,'m','Linewidth',0.5);
hold on
qq = plot(t, outH,'g','Linewidth',0.5);
hold on
rr = plot(t, outD,'c','Linewidth',0.5);


legend([xx,yy,zz,pp,qq,rr],'S(t)','E(t)','I(t)','R(t)','H(t)','D(t)');
